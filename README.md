...
**Autoencoders (AE)** are neural networks that aims to copy their input to their outputs. They work by compressing the input into a latent-space representations, and then reconstructing the output from this representation. This kind of network is composed of two parts:and
